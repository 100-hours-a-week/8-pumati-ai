...
MIDDLE_PROMPTS = {
    ...
    "project": "아직 진행중인 프로젝트야. 부하테스트 관련은 빼줘. wiki문서만 참고해. home, vision 부분을 주로 참고해서 알려줘. 문서 전체 흐름을 요약하는 방식으로, 특정 키워드 하나에만 집중하지 말고 전체 프로젝트를 설명해줘. 개발자가 누구인지는 말하지마. TanStack Query 같은 너무 기술적인 내용은 넣지 말고, 기능위주로만 해줘.",
}
